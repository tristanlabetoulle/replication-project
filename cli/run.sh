...
readonly JAR_URL='https://linqs-data.soe.ucsc.edu/maven/repositories/psl-releases/org/linqs/psl-cli/2.0.0/psl-cli-2.0.0.jar'
readonly JAR_FILE='psl-cli-2.0.0.jar'
